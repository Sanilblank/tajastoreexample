...
@section('content')
    <div class="right_col" role="main">
        ...
        @endif
        <h1 class="mt-3">Edit Product <a href="{{ route('singlevendorproduct.index') }}" class="btn btn-primary btn-sm"> <i
                    class="fa fa-eye" aria-hidden="true"></i> View My Products</a></h1>
        <div class="card mt-3">

            <form action="{{ route('singlevendorproduct.update', $product->id) }}" method="POST" class="bg-light p-3"
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="boought_price">Bought Price (From Vendor): </label>
                            <input type="text" name="bought_price" class="form-control" value="{{ $product->bought_price }}"
                        ...
                        <div class="form-group">
                            <label for="price">Product Price (Selling Price): </label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="stock" class="form-control" value="{{ $product->unit_info }}"
