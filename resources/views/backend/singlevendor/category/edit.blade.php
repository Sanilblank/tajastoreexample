...
<div class="right_col" role="main">
    <h1 class="mt-3">Edit category  <a href="{{route('singlevendorcategory.index')}}" class="btn btn-primary btn-sm"> <i class="fa fa-eye" aria-hidden="true"></i> View categories</a></h1>
    <div class="card mt-3">
        <div class="row">
            <div class="col-md-6">
               <form action="{{route('singlevendorcategory.update', $category->id)}}" method="POST" class="bg-light p-3">
                    @csrf
                    @method('PUT')
