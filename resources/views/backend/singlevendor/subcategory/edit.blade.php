...
@section('content')
    <div class="right_col" role="main">
        <h1 class="mt-3">Edit Subcategory <a href="{{ route('singlevendorsubcategory.index') }}" class="btn btn-primary btn-sm"> <i
                    class="fa fa-eye" aria-hidden="true"></i> View Subcategories</a></h1>
        <div class="card mt-3">
            <div class="row">
                <div class="col-md-6">
                    <form action="{{ route('singlevendorsubcategory.update', $subcategory->id) }}" method="POST" class="bg-light p-3"
