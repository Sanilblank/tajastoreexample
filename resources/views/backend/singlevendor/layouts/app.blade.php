...
<head>
    ...
    <title> {{$setting->sitename}} | Vendor Dashboard</title>
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-list"></i> Product Categories<span
                                    ...
                                    <ul class="nav child_menu">
                                        <li><a href="{{ route('singlevendorcategory.index') }}">Categories</a></li>
                                        <li><a href="{{route('singlevendorsubcategory.index')}}">Sub categories</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-product-hunt"></i>Our Products <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{route('singlevendorproduct.index')}}">All Products</a></li>
                                        <li><a href="{{route('singlevendorproduct.create')}}">Add new Product</a></li>
                                    </ul>
                                </li>
                                ...
                                <li><a href="{{route('singlevendororder.index')}}"><i class="fa fa-exchange"></i>Our Orders</a>
                    ...
                    <nav class="nav navbar-nav">
                        <ul class=" navbar-right">
                            ...
                            <li role="presentation" class="nav-item dropdown open">
                                ...
                                @php
                                    $vendor = DB::table('vendors')->where('name', Auth::user()->name)->where('email', Auth::user()->email)->first();
                                    $neworder = DB::table('notifications')->where('type','App\Notifications\NewOrderedProduct')->where('is_read', 0)->where('vendor_id', $vendor->id)->count();
                                    // dd($neworder);
                               ...
                               @endphp
                                ...
                                <ul class="dropdown-menu list-unstyled msg_list" role="menu"
                                    ...
                                    @if ($neworder > 0)
                                        <li class="nav-item">
                                            <a class="dropdown-item" href="{{route('singlevendororder.index')}}">
                                                <span>
